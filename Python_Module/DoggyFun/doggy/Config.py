import numpy as np
from DoggyFun.doggy.ServoCalibration import MICROS_PER_RAD, NEUTRAL_ANGLE_DEGREES
from DoggyFun.doggy.HardwareConfig import PS4_COLOR, PS4_DEACTIVATED_COLOR
