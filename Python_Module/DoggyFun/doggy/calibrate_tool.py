...
from DoggyFun.doggy.HardwareInterface import HardwareInterface
import DoggyFun.doggy.nvram as nvram
...
def main():
    ...
    ##############################################    
    MainWindow = CalibrationTool('Doggy Calibration Tool',800,500)
